                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            html: "<div>" + CKEDITOR.tools.htmlEncode(c.lang.common.preview) +
                                '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' + A + '"><img id="' + z + '" alt="" /></a>' + (c.config.image_previewText || "Текст энд байрлана. Текст энд байрлана. Текст энд байрлана. Текст энд байрлана. .") +
                                "</td></tr></table></div></div>"
                        }]
                    }]
                }]
