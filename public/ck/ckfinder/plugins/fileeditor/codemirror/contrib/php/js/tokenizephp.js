...
var tokenizePHP = (function() {
  ...
  */
  var keywords = function(){
    ...
    // reserved "languages constructs"... http://php.net/manual/en/reserved.php
    [ "die", "echo", "empty", "exit", "eval", "include", "include_once", "isset",
      ...
      result[element] = token("t_string", "php-reserved-languages-construct");
    });
  ...
  function phpToken(inside, source, setInside) {
    ...
    */
    ...
    // http://php.net/manual/en/languages.types.string.php#languages.types.string.syntax.heredoc
