...
use App\Tag;
$tags = Tag::all();
$r_posts = Post::orderByRaw("RAND()")->take(15)->get();
?>
...
<div class="widget meta-widget">
	...
	<div class="meta-tab">
		<ul class="nav nav-tabs nav-justified" role="tablist">
			<li role="presentation" class="active"><a href="#new" data-toggle="tab"><i class="fa fa-comment-o"></i>Шинэ</a></li>
			<li role="presentation"><a href="/main/#tag" data-toggle="tab"><i class="fa fa-inbox"></i>Tag</a></li>
		</ul>
							...
							<div class="post-content">	
								<div class="entry-meta">
									<ul class="list-inline">
										<li class="post-author"><a href="#">Usukhbayar,</a></li>
