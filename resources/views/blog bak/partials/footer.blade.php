...
<footer id="footer">
			...
			<div class="col-sm-4">
				<div class="widget">
					...
					<ul>
						...
						<li>
							<a><i class="fa fa-fax"></i> {{$contact->phonenumber}}</a>
						</li>
						<li>
							<a href="mailto:"><i class="fa fa-envelope-o"></i> {{$contact->email}}</a>
						</li>
					</ul>
					@else
					<ul>
						<li>
							<a>Монгол улс. Улаанбаатар хот, БГД 18-р хороо</a>
						</li>
						<li>
							<a>(976) 9999-9999, (976) 8888-8888</a>
						</li>
						<li>
							<a href="mailto:">info@ediinzasag.mn</a>
						</li>
					</ul>
					@endif
				</div>
	...
	<div class="footer-bottom">
		<div class="container text-center">
			<p><a href="">{{config('blog.title')}} </a>&copy; 2016 developed by <a href="http://www.facebook.com/oxbiuser">Usukh</a></p>
		</div>
	</div>		
</footer>